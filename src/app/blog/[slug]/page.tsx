...
function TimeCapsule({ news, reading }: { news: string; reading: string }) {
  return (
    <div className="mt-12 p-6 border-2 border-[#CBC5BA] dark:border-gray-600 bg-[#F2EDE5] dark:bg-gray-800 rounded-lg">
...
function PostNavigation({
  ...
  return (
    <nav className="mt-16 pt-8 border-t border-[#D5CFC4] dark:border-gray-700">
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  try {
    ...
    return (
      <main className="pt-16 sm:pt-20 bg-[#EDE8E0] dark:bg-gray-900">
