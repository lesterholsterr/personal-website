...
import { getBookBySlug, getAllBookSlugs, getAdjacentBooks, formatDate, type BookMeta } from '@/lib/books';
...
function BookNavigation({ prev, next }: { prev: BookMeta | null; next: BookMeta | null }) {
        ...
        {prev ? (
          ...
          >
            ...
            <div className="text-left">
              <p className="text-sm text-gray-500 dark:text-gray-500">Previous</p>
                ...
                <div className="sticky top-8">
                  ...
                  <div className="mt-6 space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900 dark:text-gray-100">{book.author}</span>
                    </div>
                    <div className="flex justify-between">
