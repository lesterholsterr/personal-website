...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#F0EBE3]/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-[#D5CFC4] dark:border-gray-800 z-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <button
              onClick={toggleMenu}
              className="p-2 rounded-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-[#F2EDE5] dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#D5CFC4] dark:focus:ring-gray-700"
        ...
        >
          <div className="py-2 space-y-1">
            <button
              ...
              className="block w-full text-left px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-[#F2EDE5] dark:hover:bg-gray-800 rounded-md transition-colors cursor-pointer"
            >
              Home
            </button>
            <Link
              href="/blog"
              className="block px-3 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-[#F2EDE5] dark:hover:bg-gray-800 rounded-md transition-colors"
