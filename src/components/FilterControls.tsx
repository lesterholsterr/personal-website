...
export default function FilterControls({ filters, onFiltersChange, bookCount }: FilterControlsProps) {
  ...
  return (
    <div className="bg-[#F2EDE5] dark:bg-gray-800/50 rounded-lg p-4 mb-8 animate-scaleIn">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className="px-3 py-2 text-sm border border-[#D5CFC4] dark:border-gray-600 rounded-lg bg-[#F0EBE3] dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all cursor-pointer"
            >
              {GENRES.map(genre => (
